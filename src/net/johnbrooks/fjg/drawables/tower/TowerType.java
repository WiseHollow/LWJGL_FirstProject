...
public enum TowerType
{
    ...
    ICE_TOWER(GameTexture.ICE_CANNON_BASE.getTexture(), GameTexture.ICE_CANNON_GUN.getTexture(), GameTexture.BULLET.getTexture(), 1, 15, 5, 256, 400, 0.1f),
    FAST_TOWER(GameTexture.CANNON_BASE.getTexture(), GameTexture.CANNON_GUN.getTexture(), GameTexture.BULLET.getTexture(), 1, 30, 0.1f, 372, 900, 1f);
