...
public enum TowerType
{
    ...
    FIRE_TOWER(GameTexture.TOWER_BASE_C.getTexture(), GameTexture.TOWER_CANNON_BURN.getTexture(), GameTexture.BULLET_BURN.getTexture(), 10, 30, 3, 256, 350, 1.2f, false),
    FAST_TOWER(GameTexture.TOWER_BASE_B.getTexture(), GameTexture.TOWER_CANNON_FAST.getTexture(), GameTexture.BULLET_LITE.getTexture(), 2, 60, 0.7f, 320, 900, 1f, false),
    TRACKING_TOWER(GameTexture.TOWER_BASE_D.getTexture(), GameTexture.TOWER_CANNON_TRACKING.getTexture(), GameTexture.BULLET_TRACKING.getTexture(), 50, 100, 5f, 512, 240, 1f, true);
