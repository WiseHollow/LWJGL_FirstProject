...
public enum TowerType
{
    ...
    FAST_TOWER(GameTexture.TOWER_BASE_B.getTexture(), GameTexture.TOWER_CANNON_FAST.getTexture(), GameTexture.BULLET_LITE.getTexture(), 3, 60, 0.7f, 320, 900, 1f, false),
    TRACKING_TOWER(GameTexture.TOWER_BASE_D.getTexture(), GameTexture.TOWER_CANNON_TRACKING.getTexture(), GameTexture.BULLET_TRACKING.getTexture(), 35, 100, 5f, 512, 240, 1f, true);
